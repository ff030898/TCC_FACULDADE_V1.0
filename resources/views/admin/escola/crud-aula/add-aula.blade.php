...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary">Cadastrar Aula</h6>
      ...
      <form method="get" action="." name="formCad">
        ...
        <div class="form-group col-md-6">
          ...
          <select id="inputState" class="form-control">
            <option selected>Escolha uma Materia</option>
        ...
        <div class="form-group col-md-3">
          <label for="inputState">Hora de Término *</label>
          <input type="time" class="form-control" id="celular" name="celular" placeholder="00:00" required>
        </div>

        <div class="form-group col-md-3">
          <label for="inputEmail4">Hora de Inicio *</label>
          <input type="time" class="form-control" id="rg" name="rg" placeholder="00:00" required>
        </div>
