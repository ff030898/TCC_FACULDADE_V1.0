...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary">Cadastrar Materia</h6>
      
    </div>
    <div class="card-body">
      <!-- Inicio do formulario -->
      <form method="post" action="{{route('adm.escola.salvar.materia')}}" name="formCad">


        <div class="form-group col-md-12">
          <label for="inputPassword4">Digite o Nome da Materia *</label>
          <input type="text" class="form-control" id="inputPassword4" name="nm_materia" placeholder="Nome da Materia">
        </div>
