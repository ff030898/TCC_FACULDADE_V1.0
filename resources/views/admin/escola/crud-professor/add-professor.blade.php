      ...
      <form method="get" action="." name="formCad">
        ...
        <div class="form-group col-md-1" style="float: left; ">
          ...
          <label class="newbtn">
            ...
            <input id="pic" class='pis' onchange="readURL(this);" type="file" name="img_prof" required>
          </label>
        ...
        <div class="form-group col-md-5">
          ...
          <input type="text" class="form-control" id="inputEmail4" name="snm_prof" placeholder="Sobrenome" required>
        </div>

        <div class="form-group col-md-5">
          <label for="inputEmail4">Nome *</label>
          <input type="text" class="form-control" id="inputEmail4" placeholder="Nome" name="nm_prof" required>
        </div>

        <div class="form-group col-md-5">
          <label for="inputEmail4">Data de Nascimento *</label>
          <input type="date" class="form-control" name="dt_nascimento" id="datan" placeholder="dd/mm/yyyy" onblur="dataNasc()" required>
        </div>

        <div class="form-group col-md-5">
          <label for="inputState">Sexo</label>
          <select id="inputState" class="form-control" name="sexo_prof">
        ...
        <div class="form-group col-md-12">
          ...
          <input type="email" class="form-control" id="inputPassword4" placeholder="Email" name="email_prof">
        </div>
